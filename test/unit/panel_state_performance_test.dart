...
void main() {
  testWidgets(
    'Rendering Optimization: Opacity widget is REMOVED when panel is fully visible',
    (tester) async {
      ...
      expect(
        hasOpacity1Wrapper(contentFinder),
        isFalse,
        reason:
            'Optimization Failed: Content is wrapped in unnecessary Opacity(1.0) widget.',
      );
    },
  );
}
