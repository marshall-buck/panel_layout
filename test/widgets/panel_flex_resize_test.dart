...
void main() {
  group('Flexible Panel Resizing', () {
    testWidgets('Resizing two flexible panels uses correct sensitivity', (tester) async {
      ...
      expect(tester.getSize(leftPanel).width, closeTo(496.0, 0.5), reason: "Left panel should grow by 100px");
      expect(tester.getSize(rightPanel).width, closeTo(296.0, 0.5), reason: "Right panel should shrink by 100px");
    });

    testWidgets('Flexible panel resize respects minSize constraints', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: PanelLayout(
      ...
      expect(tester.getSize(leftPanel).width, closeTo(350.0, 0.5), reason: "Left panel should be clamped to minSize 350");
    });
  });
}
