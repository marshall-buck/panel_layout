...
void main() {
  ...
  testWidgets('Top Panel Rotation (Closes Up)', (tester) async {
    ...
    await tester.pumpWidget(buildTestWidget(anchor: PanelAnchor.top, collapsed: false));
    final transformOpen = tester.widget<Transform>(find.descendant(
    ...
    await tester.pumpWidget(buildTestWidget(anchor: PanelAnchor.top, collapsed: true));
    ...
    final transformCollapsed = tester.widget<Transform>(find.descendant(
      of: find.byType(PanelToggleButton),
      matching: find.byType(Transform),
    ).first);
  ...
  testWidgets('Bottom Panel Rotation (Closes Down)', (tester) async {
    ...
    await tester.pumpWidget(buildTestWidget(anchor: PanelAnchor.bottom, collapsed: false));
    await tester.pumpAndSettle();
