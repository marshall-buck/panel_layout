...
void main() {
  group('Rendering Optimizations & Stability', () {
    testWidgets(
      'AnimatedVerticalPanel: Removes Opacity/IgnorePointer when stable',
      (tester) async {
        ...
        final repaintBoundaryFinder = find
            .ancestor(of: contentFinder, matching: find.byType(RepaintBoundary))
            .first;
        ...
        expect(
          hasOpacity1,
          isFalse,
          reason: 'Optimization Fail: Unnecessary Opacity(1.0) found.',
        );
        ...
        expect(
          ...
          isTrue,
          reason:
              'Animation Fail: Opacity widget should be present during animation.',
        );
      },
    );

    testWidgets(
      'AnimatedHorizontalPanel: Removes Opacity/IgnorePointer when stable',
      (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: PanelArea(
    ...
    testWidgets('AnimatedHorizontalPanel: Rail is ignored when Expanded', (
      tester,
    ) async {
      ...
      expect(
        hitTestableIcons,
        findsOneWidget,
        reason: 'Rail icon should be ignored when panel is expanded.',
      );
